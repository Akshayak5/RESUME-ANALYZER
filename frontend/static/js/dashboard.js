...
const TEST_QUESTIONS = {
  ...
  default: [
    { q:"API stands for?",                                opts:["Application Programming Interface","App Protocol Integration","Automated Process Interface","Application Process Integration"], ans:0 },
    { q:"HTTP success status code?",                      opts:["404","500","200","301"],                                  ans:2 },
    { q:"CSS stands for?",                                opts:["Computer Style Sheets","Cascading Style Sheets","Creative Style System","Code Style Script"], ans:1 },
    { q:"REST is?",                                       opts:["A database","An architectural style for APIs","A programming language","A framework"], ans:1 },
    { q:"JSON stands for?",                               opts:["JavaScript Object Notation","Java Standard Object Name","JS Online Network","None"], ans:0 },
  ],
};
